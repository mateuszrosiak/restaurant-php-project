<div class="py-20">
    ...
    <div class="grid grid-flow-row grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-10">
        ...
        foreach ($params['products'] as $param) {
            if ($param['category'] === 'burgers') {
        ?>
                <div class="shadow-lg rounded-lg">
                    <a href="#">
                        <img src="<?php echo $param['image']; ?>" alt="burger image" class="rounded-tl-lg rounded-tr-lg">
                    </a>
                    <div class="p-5">
                        <h4><a href="#"><?php echo htmlentities($param['name']); ?></a></h4>
                        ...
                        <div class="flex flex-row my-4 justify-start">
                            <a href="#" class="mr-2 text-sm bg-gradient-to-r from-red-700 to-pink-500 text-gray-50 py-2 px-3 rounded-full flex fkex-row items-center hover:from-pink-600 hover:to-pink-600">
    ...
    <div class="grid grid-flow-row grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-10">
        <?php
        foreach ($params['products'] as $param) {
            if (str_contains($param['name'], 'izza')) {
        ?>
                <div class="shadow-lg rounded-lg">
                    <a href="#">
                        <img src="<?php echo $param['image']; ?>" alt="burger image" class="rounded-tl-lg rounded-tr-lg">
